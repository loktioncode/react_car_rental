                            ...
                            <div className="form-group">
                                <div className="form-row">
                                    <div className="col-md-6">
                                        ...
                                        <label >Name</label>
                                        <input type="text" className="form-control" placeholder="Fullname" required="required" autofocus="autofocus" value={name} onChange={updateName} ></input>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-label">
                                        <label >Phone Number</label>
                                        <input type="phone"  className="form-control" placeholder="Phone number" required="required" autofocus="autofocus" value={phone} onChange={updatePhone}></input>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-row">
                                    <div className="col-md-12">
                                        <div className="form-label">
                                        <label >Email</label>
                                        <input type="email"  className="form-control" placeholder="Email" required="required" autofocus="autofocus" value={email} onChange={updateEmail}></input>
                                        </div>
                                    </div>
                                </div>
                                <div className="form-row">
                                    <div className="col-md-6">
                                        ...
                                        <input type="password" className="form-control" placeholder="Password" required="required" autofocus="autofocus" value={password} onChange={updatePass}></input>
                                        </div>
                                    </div>
                                    <div className="col-md-6">
                                        <div className="form-label">
                                        <label >Confirm Password</label>
                                        <input type="password"  className="form-control" placeholder="Confirm" required="required" autofocus="autofocus"></input>
                                        </div>
                                    </div>
                                </div>
